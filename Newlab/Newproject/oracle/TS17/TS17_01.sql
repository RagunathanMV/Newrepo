CREATE TABLE TS17_01.SUPPLIERS
(
...
CREATE TABLE TS17_01.SUPPLIERS1
(
...
CREATE TABLE TS17_01.COURSES_TBL (
...
IS    
BEGIN    
INSERT INTO TS17_01.SUPPLIERS (SUPPLIER_ID,SUPPLIER_NAME,SUPPLIER_ADDRESS) 
SELECT S1.SUPPLIER_ID1, S1.SUPPLIER_NAME1, S1.SUPPLIER_ADDRESS1 FROM TS17_01.SUPPLIERS1 S1;    
END;
--
